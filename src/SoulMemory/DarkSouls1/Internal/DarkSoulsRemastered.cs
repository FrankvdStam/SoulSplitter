...
namespace SoulMemory.DarkSouls1.Internal
{
    internal class DarkSoulsRemastered : BaseMemoryReaderWriter, IDarkSouls
    {
        ...
        public DarkSoulsRemastered()
        {
            ...
            _process.ScanCache()
                .ScanRelative("MenuPrompt", new byte?[] { 0x48, 0x8d, 0x0d, null, null, null, null, 0x48, 0x89, 0x8a, 0x38, 0x0a, 0x00, 0x00 }, 3, 7)
                    .CreatePointer(out _menuPrompt)

                //GameDataMan
                .ScanRelative("GameDataManIns", new byte?[] { 0x48, 0x8B, 0x05, null, null, null, null, 0x45, 0x33, 0xED, 0x48, 0x8B, 0xF1, 0x48, 0x85, 0xC0 }, 3, 7)
                ...
                //World progression
                .ScanRelative("WorldProgression", new byte?[] { 0x48, 0x8B, 0x0D, null, null, null, null, 0x41, 0xB8, 0x01, 0x00, 0x00, 0x00, 0x44 }, 3, 7)
                ...
                .ScanRelative("BonfireState", new byte?[]{ 0x48, 0x8b, 0x05, null, null, null, null, 0x48, 0x05, 0x08, 0x0a, 0x00, 0x00, 0x48, 0x89, 0x44, 0x24, 0x50, 0xe8, 0x34, 0xfc, 0xfd, 0xff }, 3, 7)

...
namespace SoulMemory.DarkSouls1
{
    ...
    public enum KnownFlag : uint
    {
        ...
        [AnnotationAttribute(Name = "Lordvessel, Dark Anor Londo 11510400", Description = "Lordvessel")]
        LordvesselDarkAnorLondo = 11510400,

        [AnnotationAttribute(Name = "Lordvessel, Receive Lordvessel With Gwynevere Still Alive 11510592", Description = "Lordvessel")]
        LordvesselReceiveLordvesselWithGwynevereStillAlive = 11510592,

        [AnnotationAttribute(Name = "Lordvessel, Receive Lordvessel (Gwynevere Alive or Dead) 50000090", Description = "Lordvessel")]

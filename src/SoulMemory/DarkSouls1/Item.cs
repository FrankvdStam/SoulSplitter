...
namespace SoulMemory.DarkSouls1
{
    public class Item
    {
        public Item(string name, int id, ItemType type, ItemCategory category, int stackLimit, ItemUpgrade upgrade)
        {
            Name = name;
            Id = id;
            Type = type;
        ...
        public string InfusionName => Infusion.ToString();

        public static readonly List<Item> AllItems = new List<Item>()
        {
            //Format: Item ID; Stack Limit; Reinforce Type; Name [arbitrary]

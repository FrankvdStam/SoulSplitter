...
namespace SoulSplitter.Plugin.Resources
{
    public class LanguageManager : ILanguageManager
    {
        ...
        {
            //"/TestApp;component/mainwindow.xaml"
            var resources = typeof(LanguageManager).Assembly.GetManifestResourceNames();
            var path = $"pack://application:,,,/SoulSplitter.Plugin;component/Resources/{language}/Language.xaml";

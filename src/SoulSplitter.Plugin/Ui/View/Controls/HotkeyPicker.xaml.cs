...
namespace SoulSplitter.Plugin.Ui.View.Controls
{
    public partial class HotkeyPicker : UserControl
    {
        ...
        private void OnPreviewKeyDown(object sender, KeyEventArgs e)
        {
            if (_isActive)
            {
                if (e.IsDown && sender is TextBox textBox)
                {
                    ...
                    if (ModifierKeysLookup.TryGetValue(e.Key, out ModifierKeys modifierKeys))
                    {
        ...
        private static readonly Dictionary<Key, ModifierKeys> ModifierKeysLookup = new Dictionary<Key, ModifierKeys>()
        {

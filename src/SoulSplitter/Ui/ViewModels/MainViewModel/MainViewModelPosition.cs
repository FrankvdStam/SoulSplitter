...
public partial class MainViewModel
{
    ...
    private Vector3f _currentPosition = new Vector3f(0,0,0);
    ...
    {
        get => _eldenRingPositionViewModel;
        set => SetField(ref _eldenRingPositionViewModel, value);
    }
    private EldenRingPositionViewModel? _eldenRingPositionViewModel;
}
